...
class SetControlGroupEvent(db.Model):
    __tablename__ = "SetControlGroupEvent"
    ...
    player = db.relationship('PLAYER', back_populates = 'set_control_group_events')

    __INFO__ = db.Column(db.Integer, db.ForeignKey('replay.INFO.__id__'))
    info = db.relationship('INFO', back_populates = 'set_control_group_events')
